...
The case also features a small lanyard hole for attaching a strap; the hole is 10 mm in diameter, matching the CAD parameter so standard paracord-style straps fit snugly.
